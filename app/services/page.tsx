  ...
  return (
    <main className="relative min-h-screen w-full bg-[#030303] text-white overflow-hidden pt-20 flex flex-col font-serif">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-white/1 blur-[150px]" />
      </div>

      {/* Header Info */}
      <div className="text-center pt-8 pb-6 z-20 pointer-events-none px-4">
        <span className="text-[10px] font-mono tracking-[0.4em] text-main-400 uppercase">
          CHRYSSUS DIGITAL // ECOSYSTEM
        </span>
        <h1 className="text-3xl md:text-5xl font-black tracking-tight mt-2 text-white">
          ΕΠΙΛΕΞΤΕ ΚΑΤΗΓΟΡΙΑ ΥΠΗΡΕΣΙΩΝ
        </h1>
        <p className="text-zinc-400 text-xs md:text-sm font-sans mt-2 max-w-md mx-auto">
          Εξειδικευμένες λύσεις τεχνητής νοημοσύνης, αυτοματοποίησης και ιστού για σύγχρονα οδοντιατρεία.
        </p>
      </div>
      ...
      <div className="relative flex-1 grid grid-cols-1 lg:grid-cols-3 w-full h-full min-h-[75vh] border-t border-zinc-900">
        ...
        <Link href="/services/ai" className="relative group block h-full">
          ...
          >
            ...
            {/* Geometric Core Element (Sphere / AI Core) */}
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl lg:text-4xl font-black text-white group-hover:text-amber-300 transition-colors duration-300 mb-4">
                AI Receptionist
              </h2>
              <p className="text-zinc-400 text-sm leading-relaxed font-light mb-8">
                Αυτοματοποιημένη τηλεφωνική υποδοχή 24/7 με εξειδικευμένη AI φωνή. Διαχειριστείτε ραντεβού και ερωτήσεις ασθενών αυτόματα.
              </p>
              ...
              <ul className="space-y-3 mb-8 text-xs text-zinc-300 font-sans">
                ...
                <li className="flex items-center gap-3">
                  <span className="text-amber-400 font-bold">✦</span> Smart Emergency Triage & Alerts
                </li>
              </ul>
            </div>

            {/* Bottom Call to Action */}
            <div className="relative z-10 pt-6 border-t border-zinc-800/60 flex items-center justify-between mt-auto">
        ...
        <Link href="/services/automations" className="relative group block h-full">
          ...
          >
            ...
            {/* Geometric Core Element (Rhombus / Nodes & Pipelines) */}
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl lg:text-4xl font-black text-white group-hover:text-emerald-300 transition-colors duration-300 mb-4">
                Smart Automations
              </h2>
              <p className="text-zinc-400 text-sm leading-relaxed font-light mb-8">
                Συνδέστε τα συστήματα του ιατρείου σας. Αυτοματοποιήστε υπενθυμίσεις ραντεβού, follow-ups ασθενών και εσωτερικά workflows.
              </p>
              ...
              <ul className="space-y-3 mb-8 text-xs text-zinc-300 font-sans">
                ...
                <li className="flex items-center gap-3">
                  <span className="text-emerald-400 font-bold">✦</span> SMS / Viber / Telegram Reminders
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-emerald-400 font-bold">✦</span> Automated Review & Patient Follow-up
                </li>
              </ul>
            </div>
        ...
        <Link href="/services/web" className="relative group block h-full">
          ...
          >
            ...
            {/* Geometric Core Element (Square / Interface Frame) */}
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl lg:text-4xl font-black text-white group-hover:text-cyan-300 transition-colors duration-300 mb-4">
                Web Development
              </h2>
              <p className="text-zinc-400 text-sm leading-relaxed font-light mb-8">
                Σύγχρονες, ultra-fast ιστοσελίδες ειδικά σχεδιασμένες για την προσέλκυση και μετατροπή επισκεπτών σε νέους πελάτες.
              </p>

              {/* Bullet Features */}
              <ul className="space-y-3 mb-8 text-xs text-zinc-300 font-sans">
                <li className="flex items-center gap-3">
                  <span className="text-cyan-400 font-bold">✦</span> Ειδικά διαμορφωμένο Design
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-cyan-400 font-bold">✦</span> Ταχύτατη απόδοση & SEO για την παρουσία σας στο Google
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-cyan-400 font-bold">✦</span> Πλήρης κάλυψη όλων των αναγκών της διαδυκτιακής σας παρουσίας
                </li>
              </ul>
            </div>
